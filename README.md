...
* **Category & Sub-Category Filters** → Focus on specific product types
* **State Filter** → View region-wise performance

These slicers make the dashboard interactive.
...
* Compare **sales vs profit performance**
* Understand **customer demand patterns (quantity trends)**
...
* Managers track sales & profit performance
* Businesses identify improvement areas
* Decision-makers optimize product strategy
